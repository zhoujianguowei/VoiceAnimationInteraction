...
public class PinnedSectionListView extends ListView
{
                ...
                int totalItemCount)
        {
            ...
            { // delegate
                mDelegateOnScrollListener
                        .onScroll(view, firstVisibleItem, visibleItemCount,
                                totalItemCount);
            }
    ...
    public PinnedSectionListView(
            Context context, AttributeSet attrs, int defStyle)
    {
        super(context, attrs, defStyle);
        initView();
    }
    public static boolean isItemViewTypePinned(
            ListAdapter adapter, int viewType)
    {
    ...
    public void setShadowVisible(boolean visible)
    {
        ...
        if (mPinnedSection != null)
        {
            ...
            invalidate(v.getLeft(), v.getTop(), v.getRight(),
    ...
    void createPinnedShadow(int position)
    {
        ...
        View pinnedView =
                getAdapter().getView(position, pinnedShadow.view,
     ...
     */
    void ensureShadowForPosition(
            int sectionPosition, int firstVisibleItem, int visibleItemCount)
    {
        ...
        if (nextPosition < getCount())
        {
            ...
            {
                View nextSectionView = getChildAt(
                        nextSectionPosition - firstVisibleItem);
    ...
    int findFirstVisibleSectionPosition(
    ...
    protected void dispatchDraw(Canvas canvas)
    {
        ...
        if (mPinnedSection != null)
        {
            ...
            {
                mShadowDrawable
                        .setBounds(mPinnedSection.view.getLeft(), mPinnedSection.view
                                        .getBottom(), mPinnedSection.view.getRight(),
